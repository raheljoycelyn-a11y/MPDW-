...
Hasil di atas menunjukkan bahwa hanya peubah $x_t$ yang memiliki nilai $p < 0.05$. Hal ini menunjukkan bahwa peubah $x_t$ berpengaruh signifikan terhadap $y_t$, sementara $x_{t-1}$ dan $y_{t-1}$ berpengaruh signifikan terhadap $y_t$. Model keseluruhannya adalah sebagai berikut:
